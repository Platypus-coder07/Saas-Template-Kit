                  ...
                  <form onSubmit={onPressVerify} className="space-y-4">
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        placeholder="000000"
                        className="bg-white border-stone-300 focus-visible:ring-[#2D8A78] focus-visible:ring-2 text-stone-900 h-12 text-center text-xl tracking-[0.5em] font-mono rounded-xl shadow-sm"
                        maxLength={6}
                        required
                      />
                    </div>
                    ...
                    <div className="space-y-1.5">
                      <div className="flex items-center justify-between">
                        ...
                        <Link
                          ...
                          className="text-xs font-semibold text-[#2D8A78] hover:text-[#236B5D] transition-colors"
                        >
                          Forgot password?
                        </Link>
                      </div>
